...
<CardGroup cols={2}>
  <Card title="Agent Concepts" icon="brain" href="/concepts/agents">
    Deep dive into agents, middleware, and sessions
  </Card>
  <Card title="Tool Patterns" icon="tools" href="/concepts/tools">
  ...
  <Card title="API Reference" icon="code" href="/python/api/agent">
