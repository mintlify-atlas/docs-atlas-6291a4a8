...
<Card title="Human-in-the-Loop" icon="user-check" href="/dotnet/middleware#human-approval">
...
<Card title="Multi-Agent Systems" icon="users" href="/concepts/multi-agent">
...
<CardGroup cols={2}>
  ...
  <Card title="MCP Tools" icon="plug" href="/dotnet/mcp">
