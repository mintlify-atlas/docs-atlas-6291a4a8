...
<CardGroup cols={2}>
  <Card title="Declarative Workflows" icon="file-code" href="/workflows/introduction">
    Define workflows using YAML
  </Card>
  <Card title="Durable Workflows" icon="server" href="/hosting/durable-tasks">
    Build reliable, resumable workflows
  </Card>
  <Card title="Multi-Agent Patterns" icon="users" href="/workflows/orchestration">
